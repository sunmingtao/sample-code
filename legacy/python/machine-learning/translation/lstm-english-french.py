...
print('Number of unique input tokens:', num_encoder_tokens) # 71
print('Number of unique output tokens:', num_decoder_tokens) # 94
...
def decode_sequence(input_seq):
    ...
    states_value = encoder_model.predict(input_seq) # shape = (2,1,256)
...
for seq_index in range(2000,2100):
    ...
    total_bleu+=bleu
    print('Input sentence: {}, target sentence: {} -> Decoded sentence: {}, bleu: {}'.format(input_texts[seq_index], target_sentence, decoded_sentence, bleu))
print(total_bleu/100) #0.57
