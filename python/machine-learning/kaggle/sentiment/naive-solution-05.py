...
def preprocess_phrase(phrase):
    ...
    phrase_list = stem_words(phrase_list)
    return phrase_list
...
model.save('sentiment_model_005.h5')

model = models.load_model('sentiment_model_005.h5', compile=False)
...
sub_pd.to_csv('sentiment-005.csv', index=False)
