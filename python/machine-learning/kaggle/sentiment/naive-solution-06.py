...
def preprocess_phrase(phrase):
    ...
    phrase_list = lemmatize_verbs(phrase_list)
    return phrase_list
...
model.add(LSTM(n_neurons, dropout=0.5, recurrent_dropout=0.5))
...
model.save('sentiment_model_005.h6')

model = models.load_model('sentiment_model_005.h6', compile=False)
...
sub_pd.to_csv('sentiment-006.csv', index=False)
